...
Meat shock   & $-7.610^{***}$ & $-6.291^{***}$ & $-6.291^{***}$ & $-7.610^{***}$ &  \\
             &                &                & $(1.260)$      & $(1.124)$      &  \\[6pt]
Observations & 69,529         & 69,529         & 92             & 69,529         &  \\
$R^{2}$      & 0.887          & 0.801          & 0.801          & 0.887          &  \\
\midrule
...
\item[a] Restricted wild cluster bootstrap (WCR) with Webb six-point distribution and 999 replications; province + region $\times$ wave FE.
