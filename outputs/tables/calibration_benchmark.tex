...
\midrule
Transitory ($\rho = 0$) & $0.00$ & $0$ & $-0.050$ & $-7.610$ & $152\times$ \\
Estimated $\hat{\rho}$ & $0.48$ & $0$ & $-0.026$ & $-7.610$ & $293\times$ \\
Moderate ($\rho = 0.5$) & $0.50$ & $0$ & $-0.025$ & $-7.610$ & $304\times$ \\
Permanent ($\rho = 1$) & $1.00$ & $0$ & $0$ & $-7.610$ & $\infty$ \\
\bottomrule
\end{tabular}
...
\item $\hat{\beta}_3 = -7.610$ from the preferred specification (province + region $\times$ wave FE, Table~\ref{tab:eq3_forecast_error}, column 6).
