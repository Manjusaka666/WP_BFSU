...
\midrule
Transitory ($\rho = 0$) & $0.00$ & $0$ & $-0.050$ & $-5.555$ & $111\times$ \\
Estimated $\hat{\rho}$ & $0.48$ & $0$ & $-0.026$ & $-5.555$ & $214\times$ \\
Moderate ($\rho = 0.5$) & $0.50$ & $0$ & $-0.025$ & $-5.555$ & $222\times$ \\
Permanent ($\rho = 1$) & $1.00$ & $0$ & $0$ & $-5.555$ & $\infty$ \\
\bottomrule
\end{tabular}
...
\item $\hat{\beta}_3 = -5.555$ from the preferred specification (region $\times$ wave FE, Table~\ref{tab:eq3_forecast_error}, column 4).
