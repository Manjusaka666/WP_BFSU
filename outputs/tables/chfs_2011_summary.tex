...
\footnotesize
\item \textit{Notes:} Data from the 2011 China Household Finance Survey. Inflation expectation is reverse-coded so higher values indicate more inflationary expectations. Forecast error proxy equals expected (reversed ordinal) minus realized ordinal (2012 CPI $\approx 2.6\%$).
\end{tablenotes}
\end{threeparttable}
\end{table}
