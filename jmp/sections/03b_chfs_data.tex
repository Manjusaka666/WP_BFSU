\subsection{China Household Finance Survey (CHFS)}%\label{subsec:chfs_data}
...
central to the mechanism test in Section~\ref{subsec:chfs_info_channel}.
...
Two constraints shape how the CHFS enters the analysis. First, because
the expectation question appears only in 2011, I cannot construct
within-household expectation revisions across waves. All
cross-sectional tests in Section~\ref{subsec:chfs_info_channel} exploit
between-household variation in a single wave rather than the
within-household panel variation available in the CFPS. Second, the
2011 wave predates many of the high-salience episodes that drive the
aggregate results (trade war, pork-price spike, pandemic). The CHFS
