...
The sample ($N \approx 32$) is too small for precise inference.
The Carlson--Parkin quantification introduces
measurement error.
And aggregate time-series regressions cannot rule out
...
The meat CPI data used for shock construction begin in
...
estimation sample.
The consistency of results across the 2016, 2018,
2020, and 2022 waves, as shown in the wave-specific
meat-shock summary statistics, also indicates that the
relationship between meat shocks and expectations is stable
within the post-revision period.
