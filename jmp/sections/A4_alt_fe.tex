...
\multicolumn{6}{l}{\textit{Panel A: Expectation equation
  (Eq 1)}} \\
& Province + wave       & 0.090  & 0.053  & 0.088
  & 90,133 \\
& Region $\times$ wave & 0.242  & 0.174  & 0.237
  & 90,133 \\
& Province + region $\times$ wave & 0.119  & 0.050  & 0.024
  & 90,133 \\[6pt]
\multicolumn{6}{l}{\textit{Panel B: Forecast-error equation
  (Eq 3)}} \\
& Province + wave       & $-5.351$ & 1.201  & $<0.001$
  & 69,533 \\
& Region $\times$ wave & $-5.555$ & 1.198  & $<0.001$
  & 69,533 \\
& Province + region $\times$ wave & $-7.127$ & 1.193  & $<0.001$
  & 69,533 \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
...
FE structures: from $-5.351$ (province-plus-wave) to $-5.555$
(region-by-wave) to $-7.127$ (province-plus-region-by-wave).
All three estimates are precisely estimated with $p < 0.001$
...
$\hat{\beta}_1 = 0.119$ ($p = 0.024$) with a standard error
of 0.050.
