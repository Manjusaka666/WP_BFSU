...
The forecast-error sample is smaller (69,533 observations)
...
First, the outlet sample may not fully represent rural areas,
...
Second, the transition from separate urban and rural CPI
baskets to a unified basket in 2016 may create a level shift
...
First, the sample period includes the post-ASF price reversal of
2021--2022, during which headline CPI inflation fell below
1 percent.
Second, the $\{-1, 0, 1\}$ coding treats ``stay the
